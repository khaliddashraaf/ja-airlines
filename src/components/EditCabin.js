...
//   }
 ...
 onSubmit(e){
    ...
    // var a=localStorage.getItem("Cabin22");
    console.log(localStorage.getItem("Price22")+" please")
    if(this.state.Cabin=='')
     this.setState({Cabin:'Economy'})
    console.log('http://localhost:8000/Flights/SearchUser?'+'Date='+e+'&To='+
    d+'&From='+c+'&Cabin='+this.state.Cabin+'&Seats='+b )
    axios.get('http://localhost:8000/Flights/SearchUser?'+'Date='+e+'&To='+
