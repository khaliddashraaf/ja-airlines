              ...
              {stableSort(rows, getComparator(order, orderBy))
                ...
                .map((row, index) => {
                  ...
                  return (
                    <TableRow
                      hover
                      onClick={(event) => handleClick(event, row.FlightNumber)}
                      role="checkbox"
                    ...
                    >
                      ...
                      <TableCell align="right">{row.DepartureAirport}</TableCell>
                      <TableCell align="right">{row.ArrivalAirport}</TableCell>
                      <TableCell align="right">{row.Date}</TableCell>
                      <TableCell align="right">{row.DepartureTime}</TableCell>
                      <TableCell align="right">{row.ArrivalTime}</TableCell>
                      <TableCell align="right">{row.EconomySeats}</TableCell>
                      <TableCell align="right">{row.BusinessSeats}</TableCell>
                    </TableRow>
                  );
                })}
              {emptyRows > 0 && (
